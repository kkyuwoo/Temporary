...
public class MainGUI extends JFrame {
    ...
    private void loadCharImages() {
        String[][] imgResoruces = {
                {"normal", "src/main/java/day2/opgame/res/images/character_men.gif"},
                {"success", "src/main/java/day2/opgame/res/images/character_men_a.gif"},
                {"fail", "src/main/java/day2/opgame/res/images/character_men_a.gif"}
        };
